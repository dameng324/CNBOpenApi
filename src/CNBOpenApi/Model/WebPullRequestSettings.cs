...
namespace CNBOpenApi.Model
{
    ...
    /// </summary>
    public partial class WebPullRequestSettings : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebPullRequestSettings" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public WebPullRequestSettings(Option<bool?> allowMergeCommitMerge = default, Option<bool?> allowRebaseMerge = default, Option<bool?> allowSquashMerge = default, Option<bool?> masterAutoAsReviewer = default, Option<string?> mergeCommitMessageStyle = default, Option<string?> squashCommitMessageStyle = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebPullRequestSettings {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="WebPullRequestSettings" />
    /// </summary>
    public class WebPullRequestSettingsJsonConverter : JsonConverter<WebPullRequestSettings>
    {
        /// <summary>
        /// Deserializes json to <see cref="WebPullRequestSettings" />
        /// </summary>
        ...
        public override WebPullRequestSettings Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (allowMergeCommitMerge.IsSet && allowMergeCommitMerge.Value == null)
                throw new ArgumentNullException(nameof(allowMergeCommitMerge), "Property is not nullable for class WebPullRequestSettings.");

            if (allowRebaseMerge.IsSet && allowRebaseMerge.Value == null)
                throw new ArgumentNullException(nameof(allowRebaseMerge), "Property is not nullable for class WebPullRequestSettings.");

            if (allowSquashMerge.IsSet && allowSquashMerge.Value == null)
                throw new ArgumentNullException(nameof(allowSquashMerge), "Property is not nullable for class WebPullRequestSettings.");

            if (masterAutoAsReviewer.IsSet && masterAutoAsReviewer.Value == null)
                throw new ArgumentNullException(nameof(masterAutoAsReviewer), "Property is not nullable for class WebPullRequestSettings.");

            if (mergeCommitMessageStyle.IsSet && mergeCommitMessageStyle.Value == null)
                throw new ArgumentNullException(nameof(mergeCommitMessageStyle), "Property is not nullable for class WebPullRequestSettings.");

            if (squashCommitMessageStyle.IsSet && squashCommitMessageStyle.Value == null)
                throw new ArgumentNullException(nameof(squashCommitMessageStyle), "Property is not nullable for class WebPullRequestSettings.");

            return new WebPullRequestSettings(allowMergeCommitMerge, allowRebaseMerge, allowSquashMerge, masterAutoAsReviewer, mergeCommitMessageStyle, squashCommitMessageStyle);
        }

        /// <summary>
        /// Serializes a <see cref="WebPullRequestSettings" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webPullRequestSettings"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WebPullRequestSettings webPullRequestSettings, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, webPullRequestSettings, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WebPullRequestSettings" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webPullRequestSettings"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WebPullRequestSettings webPullRequestSettings, JsonSerializerOptions jsonSerializerOptions)
        {
            if (webPullRequestSettings.MergeCommitMessageStyleOption.IsSet && webPullRequestSettings.MergeCommitMessageStyle == null)
                throw new ArgumentNullException(nameof(webPullRequestSettings.MergeCommitMessageStyle), "Property is required for class WebPullRequestSettings.");

            if (webPullRequestSettings.SquashCommitMessageStyleOption.IsSet && webPullRequestSettings.SquashCommitMessageStyle == null)
                throw new ArgumentNullException(nameof(webPullRequestSettings.SquashCommitMessageStyle), "Property is required for class WebPullRequestSettings.");

            if (webPullRequestSettings.AllowMergeCommitMergeOption.IsSet)
                writer.WriteBoolean("allow_merge_commit_merge", webPullRequestSettings.AllowMergeCommitMergeOption.Value!.Value);

            if (webPullRequestSettings.AllowRebaseMergeOption.IsSet)
                writer.WriteBoolean("allow_rebase_merge", webPullRequestSettings.AllowRebaseMergeOption.Value!.Value);

            if (webPullRequestSettings.AllowSquashMergeOption.IsSet)
                writer.WriteBoolean("allow_squash_merge", webPullRequestSettings.AllowSquashMergeOption.Value!.Value);

            if (webPullRequestSettings.MasterAutoAsReviewerOption.IsSet)
                writer.WriteBoolean("master_auto_as_reviewer", webPullRequestSettings.MasterAutoAsReviewerOption.Value!.Value);

            if (webPullRequestSettings.MergeCommitMessageStyleOption.IsSet)
                writer.WriteString("merge_commit_message_style", webPullRequestSettings.MergeCommitMessageStyle);

            if (webPullRequestSettings.SquashCommitMessageStyleOption.IsSet)
                writer.WriteString("squash_commit_message_style", webPullRequestSettings.SquashCommitMessageStyle);
        }
    }
}
