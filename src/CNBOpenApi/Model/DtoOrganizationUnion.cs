...
namespace CNBOpenApi.Model
{
    ...
    /// </summary>
    public partial class DtoOrganizationUnion : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoOrganizationUnion" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DtoOrganizationUnion {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="DtoOrganizationUnion" />
    /// </summary>
    public class DtoOrganizationUnionJsonConverter : JsonConverter<DtoOrganizationUnion>
    {
        /// <summary>
        /// Deserializes json to <see cref="DtoOrganizationUnion" />
        /// </summary>
        ...
        public override DtoOrganizationUnion Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (allMemberCount.IsSet && allMemberCount.Value == null)
                throw new ArgumentNullException(nameof(allMemberCount), "Property is not nullable for class DtoOrganizationUnion.");

            if (allSubGroupCount.IsSet && allSubGroupCount.Value == null)
                throw new ArgumentNullException(nameof(allSubGroupCount), "Property is not nullable for class DtoOrganizationUnion.");

            if (allSubMissionCount.IsSet && allSubMissionCount.Value == null)
                throw new ArgumentNullException(nameof(allSubMissionCount), "Property is not nullable for class DtoOrganizationUnion.");

            if (allSubRegistryCount.IsSet && allSubRegistryCount.Value == null)
                throw new ArgumentNullException(nameof(allSubRegistryCount), "Property is not nullable for class DtoOrganizationUnion.");

            if (allSubRepoCount.IsSet && allSubRepoCount.Value == null)
                throw new ArgumentNullException(nameof(allSubRepoCount), "Property is not nullable for class DtoOrganizationUnion.");

            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class DtoOrganizationUnion.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class DtoOrganizationUnion.");

            if (domain.IsSet && domain.Value == null)
                throw new ArgumentNullException(nameof(domain), "Property is not nullable for class DtoOrganizationUnion.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class DtoOrganizationUnion.");

            if (followCount.IsSet && followCount.Value == null)
                throw new ArgumentNullException(nameof(followCount), "Property is not nullable for class DtoOrganizationUnion.");

            if (freeze.IsSet && freeze.Value == null)
                throw new ArgumentNullException(nameof(freeze), "Property is not nullable for class DtoOrganizationUnion.");

            if (hasSubGroup.IsSet && hasSubGroup.Value == null)
                throw new ArgumentNullException(nameof(hasSubGroup), "Property is not nullable for class DtoOrganizationUnion.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class DtoOrganizationUnion.");

            if (memberCount.IsSet && memberCount.Value == null)
                throw new ArgumentNullException(nameof(memberCount), "Property is not nullable for class DtoOrganizationUnion.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class DtoOrganizationUnion.");

            if (path.IsSet && path.Value == null)
                throw new ArgumentNullException(nameof(path), "Property is not nullable for class DtoOrganizationUnion.");

            if (remark.IsSet && remark.Value == null)
                throw new ArgumentNullException(nameof(remark), "Property is not nullable for class DtoOrganizationUnion.");

            if (site.IsSet && site.Value == null)
                throw new ArgumentNullException(nameof(site), "Property is not nullable for class DtoOrganizationUnion.");

            if (subGroupCount.IsSet && subGroupCount.Value == null)
                throw new ArgumentNullException(nameof(subGroupCount), "Property is not nullable for class DtoOrganizationUnion.");

            if (subMissionCount.IsSet && subMissionCount.Value == null)
                throw new ArgumentNullException(nameof(subMissionCount), "Property is not nullable for class DtoOrganizationUnion.");

            if (subRegistryCount.IsSet && subRegistryCount.Value == null)
                throw new ArgumentNullException(nameof(subRegistryCount), "Property is not nullable for class DtoOrganizationUnion.");

            if (subRepoCount.IsSet && subRepoCount.Value == null)
                throw new ArgumentNullException(nameof(subRepoCount), "Property is not nullable for class DtoOrganizationUnion.");

            if (updatedAt.IsSet && updatedAt.Value == null)
                throw new ArgumentNullException(nameof(updatedAt), "Property is not nullable for class DtoOrganizationUnion.");

            if (wechatMp.IsSet && wechatMp.Value == null)
                throw new ArgumentNullException(nameof(wechatMp), "Property is not nullable for class DtoOrganizationUnion.");

            return new DtoOrganizationUnion(allMemberCount, allSubGroupCount, allSubMissionCount, allSubRegistryCount, allSubRepoCount, createdAt, description, domain, email, followCount, freeze, hasSubGroup, id, memberCount, name, path, remark, site, subGroupCount, subMissionCount, subRegistryCount, subRepoCount, updatedAt, wechatMp);
        }

        /// <summary>
        /// Serializes a <see cref="DtoOrganizationUnion" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dtoOrganizationUnion"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DtoOrganizationUnion dtoOrganizationUnion, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, dtoOrganizationUnion, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DtoOrganizationUnion" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dtoOrganizationUnion"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DtoOrganizationUnion dtoOrganizationUnion, JsonSerializerOptions jsonSerializerOptions)
        {
            if (dtoOrganizationUnion.CreatedAtOption.IsSet && dtoOrganizationUnion.CreatedAt == null)
                throw new ArgumentNullException(nameof(dtoOrganizationUnion.CreatedAt), "Property is required for class DtoOrganizationUnion.");

            if (dtoOrganizationUnion.DescriptionOption.IsSet && dtoOrganizationUnion.Description == null)
                throw new ArgumentNullException(nameof(dtoOrganizationUnion.Description), "Property is required for class DtoOrganizationUnion.");

            if (dtoOrganizationUnion.DomainOption.IsSet && dtoOrganizationUnion.Domain == null)
                throw new ArgumentNullException(nameof(dtoOrganizationUnion.Domain), "Property is required for class DtoOrganizationUnion.");

            if (dtoOrganizationUnion.EmailOption.IsSet && dtoOrganizationUnion.Email == null)
                throw new ArgumentNullException(nameof(dtoOrganizationUnion.Email), "Property is required for class DtoOrganizationUnion.");

            if (dtoOrganizationUnion.NameOption.IsSet && dtoOrganizationUnion.Name == null)
                throw new ArgumentNullException(nameof(dtoOrganizationUnion.Name), "Property is required for class DtoOrganizationUnion.");

            if (dtoOrganizationUnion.PathOption.IsSet && dtoOrganizationUnion.Path == null)
                throw new ArgumentNullException(nameof(dtoOrganizationUnion.Path), "Property is required for class DtoOrganizationUnion.");

            if (dtoOrganizationUnion.RemarkOption.IsSet && dtoOrganizationUnion.Remark == null)
                throw new ArgumentNullException(nameof(dtoOrganizationUnion.Remark), "Property is required for class DtoOrganizationUnion.");

            if (dtoOrganizationUnion.SiteOption.IsSet && dtoOrganizationUnion.Site == null)
                throw new ArgumentNullException(nameof(dtoOrganizationUnion.Site), "Property is required for class DtoOrganizationUnion.");

            if (dtoOrganizationUnion.UpdatedAtOption.IsSet && dtoOrganizationUnion.UpdatedAt == null)
                throw new ArgumentNullException(nameof(dtoOrganizationUnion.UpdatedAt), "Property is required for class DtoOrganizationUnion.");

            if (dtoOrganizationUnion.WechatMpOption.IsSet && dtoOrganizationUnion.WechatMp == null)
                throw new ArgumentNullException(nameof(dtoOrganizationUnion.WechatMp), "Property is required for class DtoOrganizationUnion.");

            if (dtoOrganizationUnion.AllMemberCountOption.IsSet)
                writer.WriteNumber("all_member_count", dtoOrganizationUnion.AllMemberCountOption.Value!.Value);

            if (dtoOrganizationUnion.AllSubGroupCountOption.IsSet)
                writer.WriteNumber("all_sub_group_count", dtoOrganizationUnion.AllSubGroupCountOption.Value!.Value);

            if (dtoOrganizationUnion.AllSubMissionCountOption.IsSet)
                writer.WriteNumber("all_sub_mission_count", dtoOrganizationUnion.AllSubMissionCountOption.Value!.Value);

            if (dtoOrganizationUnion.AllSubRegistryCountOption.IsSet)
                writer.WriteNumber("all_sub_registry_count", dtoOrganizationUnion.AllSubRegistryCountOption.Value!.Value);

            if (dtoOrganizationUnion.AllSubRepoCountOption.IsSet)
                writer.WriteNumber("all_sub_repo_count", dtoOrganizationUnion.AllSubRepoCountOption.Value!.Value);

            if (dtoOrganizationUnion.CreatedAtOption.IsSet)
                writer.WriteString("created_at", dtoOrganizationUnion.CreatedAt);

            if (dtoOrganizationUnion.DescriptionOption.IsSet)
                writer.WriteString("description", dtoOrganizationUnion.Description);

            if (dtoOrganizationUnion.DomainOption.IsSet)
                writer.WriteString("domain", dtoOrganizationUnion.Domain);

            if (dtoOrganizationUnion.EmailOption.IsSet)
                writer.WriteString("email", dtoOrganizationUnion.Email);

            if (dtoOrganizationUnion.FollowCountOption.IsSet)
                writer.WriteNumber("follow_count", dtoOrganizationUnion.FollowCountOption.Value!.Value);

            if (dtoOrganizationUnion.FreezeOption.IsSet)
                writer.WriteBoolean("freeze", dtoOrganizationUnion.FreezeOption.Value!.Value);

            if (dtoOrganizationUnion.HasSubGroupOption.IsSet)
                writer.WriteBoolean("has_sub_group", dtoOrganizationUnion.HasSubGroupOption.Value!.Value);

            if (dtoOrganizationUnion.IdOption.IsSet)
                writer.WriteNumber("id", dtoOrganizationUnion.IdOption.Value!.Value);

            if (dtoOrganizationUnion.MemberCountOption.IsSet)
                writer.WriteNumber("member_count", dtoOrganizationUnion.MemberCountOption.Value!.Value);

            if (dtoOrganizationUnion.NameOption.IsSet)
                writer.WriteString("name", dtoOrganizationUnion.Name);

            if (dtoOrganizationUnion.PathOption.IsSet)
                writer.WriteString("path", dtoOrganizationUnion.Path);

            if (dtoOrganizationUnion.RemarkOption.IsSet)
                writer.WriteString("remark", dtoOrganizationUnion.Remark);

            if (dtoOrganizationUnion.SiteOption.IsSet)
                writer.WriteString("site", dtoOrganizationUnion.Site);

            if (dtoOrganizationUnion.SubGroupCountOption.IsSet)
                writer.WriteNumber("sub_group_count", dtoOrganizationUnion.SubGroupCountOption.Value!.Value);

            if (dtoOrganizationUnion.SubMissionCountOption.IsSet)
                writer.WriteNumber("sub_mission_count", dtoOrganizationUnion.SubMissionCountOption.Value!.Value);

            if (dtoOrganizationUnion.SubRegistryCountOption.IsSet)
                writer.WriteNumber("sub_registry_count", dtoOrganizationUnion.SubRegistryCountOption.Value!.Value);

            if (dtoOrganizationUnion.SubRepoCountOption.IsSet)
                writer.WriteNumber("sub_repo_count", dtoOrganizationUnion.SubRepoCountOption.Value!.Value);

            if (dtoOrganizationUnion.UpdatedAtOption.IsSet)
                writer.WriteString("updated_at", dtoOrganizationUnion.UpdatedAt);

            if (dtoOrganizationUnion.WechatMpOption.IsSet)
                writer.WriteString("wechat_mp", dtoOrganizationUnion.WechatMp);
        }
    }
}
